...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Service/ImmatriculationService.php';
        ...
        $a->addFixtures([['fixture' => new \App\DataFixtures\AppFixtures(new \App\Service\ImmatriculationService(($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container)))), 'groups' => []]]);
